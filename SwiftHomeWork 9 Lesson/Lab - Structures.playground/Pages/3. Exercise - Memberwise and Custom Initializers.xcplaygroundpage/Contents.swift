...
var favoriteBook = Book(title: "Some_title", author: "Some_author", pages: 10, price: 10)
print(favoriteBook)
/*:
...
struct Height {
    ...
    init(forInches inches: Double) {
        heightInCentimeters = inches * 2.54
        heightInInches = inches
    }
    init(forCentimeters centimeters: Double) {
 ...
 */
var someonesHeight = Height(forInches: 65)
 ...
 */
var myHeight = Height(forCentimeters: 170)
print(myHeight)
