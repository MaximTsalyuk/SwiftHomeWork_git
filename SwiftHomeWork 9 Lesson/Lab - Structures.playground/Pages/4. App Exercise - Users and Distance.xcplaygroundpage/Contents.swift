 ...
 */
var maxim = User(name: "Maxim", age: 19, height: 170, weight: 66, activityLevel: 10)
print(maxim)
/*:
...
struct Distance {
    var meters: Double
    var feet: Double
    init(forMeters metersInit: Double) {
        feet = metersInit *  3.28084
        meters = metersInit
    }
    init(forFeet feetInit: Double) {
        feet = feetInit
        meters = feetInit / 3.28084
    }
}
/*:
 Now create an instance of `Distance` called `mile`. Use the initializer for meters to set the distance to 1600. Print out the property for feet and verify that it is equal to 5249.344.
 */
var mile = Distance(forMeters: 1600)
print(mile)
/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
var mile2 = Distance(forFeet: 5000)
print(mile2)
